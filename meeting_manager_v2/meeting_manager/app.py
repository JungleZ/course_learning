...
PHASE_CONFIG = [
    {"key": "init", "name_zh": "签到与开场", "name_en": "Init", "color": "bg-init text-white"},
    {"key": "table_topics", "name_zh": "即兴演讲", "name_en": "Table Topics", "color": "bg-topics text-white"},
    {"key": "speech", "name_zh": "备稿演讲", "name_en": "Prepared Speech", "color": "bg-speech text-white"},
    {"key": "break", "name_zh": "中场休息", "name_en": "Break", "color": "bg-break text-dark"},
    {"key": "evaluation", "name_zh": "点评环节", "name_en": "Evaluation", "color": "bg-eval text-white"},
    {"key": "workshop", "name_zh": "工作坊", "name_en": "Workshop", "color": "bg-workshop text-white"},
    {"key": "closing", "name_zh": "闭幕总结", "name_en": "Closing", "color": "bg-closing text-white"},
]
